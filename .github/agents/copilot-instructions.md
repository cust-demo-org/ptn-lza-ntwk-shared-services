...
- HCL (Terraform ~> 1.9) + 14 AVM modules (resource_group v0.2.2, log_analytics_workspace v0.5.1, NSG v0.5.1, route_table v0.5.0, virtual_network v0.17.1, private_dns_zone v0.5.0, managed_identity v0.4.0, key_vault v0.10.2, storage_account v0.6.7, role_assignment v0.3.0, vhub_vnet_connection submodule v0.13.5, bastion_host v0.9.0, network_watcher v0.3.2, private_dns_zone_virtual_network_link submodule v0.5.0) (003-avm-variable-descriptions)
