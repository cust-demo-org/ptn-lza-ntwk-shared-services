...
Each entry in a `byo_private_dns_zone_virtual_network_links` map variable will create an instance of the `private_dns_virtual_network_link` submodule from `Azure/avm-res-network-privatednszone/azurerm//modules/private_dns_virtual_network_link`.
