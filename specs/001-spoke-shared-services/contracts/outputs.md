...
5. **terraform-docs compatibility**: All outputs have `description` attributes. Output documentation is auto-generated by `terraform-docs` (formatter: `"markdown document"`) into the README via the `.terraform-docs.yml` content template, which includes `{{ .Outputs }}`.
