...
| 10 | `byo_private_dns_zones` | L562 | `map(object)` | private_dns_zone_virtual_network_link submodule v0.5.0 | ~5 (zone_key, vnet_key, registration_enabled) |
...
| `virtual_network.key` | vhub_connectivity_definitions, flowlog_configuration (flow_logs), private_dns_zones (virtual_network_links), byo_private_dns_zones, bastion_hosts (virtual_network) | `virtual_networks` variable |
...
| 5 | `byo_private_dns_zones` | Low | ~5 attrs, cross-ref keys |
